...
public class BlogpostStub {
	...
	static {
		Blogpost a = new Blogpost(1L, "blog 1", "d1 devops",	"A SERVER", "", null);
		sinfo.put(1L, a);
		Blogpost b = new Blogpost(2L, "blog 2", "d1 devops",	"B SERVER", "", null);
		sinfo.put(2L, b);
		Blogpost c = new Blogpost(3L, "blog 3", "d1 devops",	"C SERVER", "", null);
		sinfo.put(3L, c);
	}
